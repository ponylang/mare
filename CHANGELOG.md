...
- Update to work with ponyc 0.72.0 ([PR #81](https://github.com/ponylang/mare/pull/81))
...
- Update to work with ponyc 0.70.0 ([PR #77](https://github.com/ponylang/mare/pull/77))

## [0.7.0] - 2026-08-21

### Changed

- Require ponyc 0.69.1 or later ([PR #76](https://github.com/ponylang/mare/pull/76))

## [0.6.2] - 2026-08-07

### Fixed

- Send TLS close_notify on graceful close ([PR #65](https://github.com/ponylang/mare/pull/65))
